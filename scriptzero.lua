-- Steal the Brainrots - TP Ultra Optimizado
local Players = game:GetService("Players")
local TweenService = game:GetService("TweenService")
local player = Players.LocalPlayer
local savedPos = nil
local cooldown = false
local cooldownTime = 0.8 -- cooldown rápido

-- Función para obtener HRP
...
title.Text = "TP Ultra Optimizado"
...
local function doTeleport()
    local char = player.Character or player.CharacterAdded:Wait()
    local hrp = getHRP(char)
    if not hrp or not savedPos then return end
...
print("[TP Ultra] Cargado, listo para Steal the Brainrots")
